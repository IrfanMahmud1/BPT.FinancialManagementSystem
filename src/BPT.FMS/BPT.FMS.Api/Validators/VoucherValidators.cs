...
{
    public class VoucherEntryDtoValidator : AbstractValidator<VoucherEntryDto>
    {
        public VoucherEntryDtoValidator()
        {
    ...
    public class VoucherDtoValidator : AbstractValidator<VoucherDto>
    {
        public VoucherDtoValidator()
        {
            ...
            RuleFor(x => x.Entries)
                ...
                .ForEach(rule => rule.SetValidator(new VoucherEntryDtoValidator()));
